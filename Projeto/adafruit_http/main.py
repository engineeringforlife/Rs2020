...
app_eui = ubinascii.unhexlify('70B3D57ED0039568')  # codigo mac do lopy
app_key = ubinascii.unhexlify('7949EED559C6CC2410A6FEBE4DF570EC')
...
# # Send new data with a value of 60 para o feed do aidafruit
#curl -F 'value=60' -H "X-AIO-Key: aio_EFLS39OMCN4twYY8gvt4SY6qG9mQ" https://io.adafruit.com/api/v2/2181665/feeds/temp3/data
